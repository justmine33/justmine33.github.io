        ...
        <nav>
            <ul>
                ...
                if(isset($_SESSION['is_login']) && $_SESSION['is_login'] == true) { ?>
                    ...
                    <?php } ?>
                    <li><a href="../logout.php" onclick="return confirm('Apakah Anda yakin ingin logout?')"><img src="../assets/icon-logout.png" alt="logout"></a></li>
                ...
                <?php } else { ?>
                    ...
                    <li><a href="login.php"><img src="assets/icon-login.png" alt="login"></a></li>
                <?php } ?>
            </ul>
        </nav>
